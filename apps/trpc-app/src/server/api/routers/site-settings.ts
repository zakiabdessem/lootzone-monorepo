      ...
      settings = await ctx.db.siteSettings.create({
        data: {
          ...
          siteAnnouncementHtml:
            '<strong class="mr-1">Grand Launch Celebration:</strong> Stand a chance to win Membership giveaways! <a href="#" class="underline ml-2 font-medium hover:text-gray-200">Join Now</a>',
