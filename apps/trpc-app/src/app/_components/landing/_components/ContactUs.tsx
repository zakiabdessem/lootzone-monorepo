...
import { useTelegramLink, useWhatsAppLink } from '~/contexts/SiteSettingsContext';
  ...
  return (
    <section className='py-24 bg-[#f8f7ff]'>
      <div className='max-w-[1440px] mx-auto px-4 text-center flex flex-col justify-center items-center'>
        <h2 className='text-3xl font-extrabold text-[#212121] mb-4'>Need Help? Contact Us</h2>
        <p className='text-gray-600 mb-8'>
          Our team is available on WhatsApp to answer your questions and assist you with your
          orders.
        </p>
